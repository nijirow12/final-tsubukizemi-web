...
export const PIN_COORDINATES = {
  ...
  jordan:      { lat: 30.5852,  lng: 36.2384,   label: 'Jordan',       labelJa: 'ヨルダン' },
  ...
  vatican:     { lat: 41.9029,  lng: 12.4534,   label: 'Vatican City', labelJa: 'バチカン' },
  spain:       { lat: 40.4637,  lng: -3.7492,   label: 'Spain',        labelJa: 'スペイン' },
  belgium:     { lat: 50.5039,  lng: 4.4699,    label: 'Belgium',      labelJa: 'ベルギー' },
  netherlands: { lat: 52.1326,  lng: 5.2913,    label: 'Netherlands',  labelJa: 'オランダ' },
  poland:      { lat: 51.9194,  lng: 19.1451,   label: 'Poland',       labelJa: 'ポーランド' },
  austria:     { lat: 47.5162,  lng: 14.5501,   label: 'Austria',      labelJa: 'オーストリア' },
  czechia:     { lat: 49.8175,  lng: 15.473,    label: 'Czechia',      labelJa: 'チェコ' },
